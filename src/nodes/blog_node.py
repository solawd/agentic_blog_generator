...
class BlogNode:
    ...
    def content_generation(self,state:BlogState):
        if "topic" in state and state["topic"]:
            ...
            Generate a succinct blog content with detailed breakdown for the {topic}.
            """
    ...
    def translation(self,state:BlogState):
        ...
        Where there is no available translation or there is an error in translation, keep the original content
        Maintain the original tone, style, and formatting.
        Adapt cultural references and idioms to be appropriate for the {current_language} language.
        ...
        translation_item = self.llm.invoke(messages)
        return {"blog": {"title": state['blog']['title'], "content": translation_item.content}}
